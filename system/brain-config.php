...
$db['pass'] = '12345'; //Mysql's password
$db['db'] = "nitro"; //Mysql's database
...
$hotel['swfFolder'] = "http://localhost/swf/gordon/PRODUCTION-201701242205-837386173";
$hotel['swfFolderSwf'] = "http://localhost/swf/gordon/PRODUCTION-201701242205-837386173/habbo2.swf";
...
$config['skin'] = "rtX"; //Skin/template of your website
$config['lang'] = "en"; //Language of your website en/nl/es
$config['hotelName'] = "rtX"; //Name of your hotel
...
/* Register Setting */
$config['startMotto'] = "RTX!"; //Register start motto
$config['credits']	= "10000";
$config['duckets']	= "20000";
$config['diamonds']	= "10";
$config['diamondsRef']	= "10";
$config['registerLook'] = 'ch-230-91.sh-290-62.hd-190-1370.hr-832-1380.lg-270-110';
